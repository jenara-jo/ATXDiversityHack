...
public class AddContactFragment extends Fragment  {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        nameEditText = (EditText) getActivity().findViewById(R.id.fragment_add_contact_name);
        descriptionEditText = (EditText) getActivity().findViewById(R.id.fragment_add_contact_description);
        phoneEditText = (EditText) getActivity().findViewById(R.id.fragment_add_contact_phone);
        addressEditText = (EditText) getActivity().findViewById(R.id.fragment_add_contact_address);
        emailEditText = (EditText) getActivity().findViewById(R.id.fragment_add_contact_email);
    }
    ...
    public void saveInformation (){
        ...
        String referenceString = descriptionEditText.getText().toString().trim();
        ...
        ContactManager.getManager().addClient(nameString,referenceString,phoneString,emailString,addressString,"");
